...
define("logo","https://imageshack.com/scaled/large/820/ovto.png");
...
class Mail{
	...
	//fasaludips@hotmail.com

	public function __construct($sender_name = "Fasalud Cisnes", $sender_mail = "info@gomosoft.com", $save = false , $lang = "es-CO"){
...
box-shadow: 0 1px 1px rgba(0, 0, 0, .5);'>
          <thead>
            <tr><td style='letter-spacing: 1px;background: #4d90fe;color: white;padding: 7px 0;text-align: center;font-size: 11px;'>Permite mostrar las imagenes del correo, para una mejor experiencia visual</td></tr>
            <tr>
               <td style='padding-top:10px'>%head%</td>
            </tr>
          </thead>
          <tbody>
          <tr>
 ...
 // function error String || Array
	...
	public function send($mail = "fasaludips@hotmail.com", $name = "Fasalud Cisnes", $subject = "Gracias por escribirnos"){
